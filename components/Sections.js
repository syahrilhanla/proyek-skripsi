      ...
      <div className={homeStyle.contentWrap}>
        ...
        <div className={homeStyle.gridKD}>
          <ul>
            <li>
              <h3>3.10</h3>
              <p>Menganalisis data berdasarkan distribusi data, nilai rata-rata, median, dan modus sebaran data untuk mengambil kesimpulan, membuat keputusan, dan membuat prediksi</p>
            </li>
            <li>
              <h3>4.10</h3>
              <p>Menyajikan dan menyelesaikan masalah yang berkaitan dengan distribusi data, nilai rata-rata, median, modus, dan sebaran data untuk mengambil simpulan, membuat keputusan, dan membuat prediksi</p>
            </li>
          </ul>
        </div>
      </div>
