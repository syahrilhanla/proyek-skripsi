...
const page4 = () => {
	...
	const scrollAct = {
		// should be act1, now its just for testing
		id: "act3",
		act: (
			<div>
				<p>
				...
				<p>
					...
					tersebut didapatkan persentase dari jumlah keseluruhan. Berdasarkan
					data yang ini kita dapat membuatnya menjadi berbagai macam jenis
					diagram. Di bawah merupakan hasil dari pembuatan diagram batang
					menggunakan data yang sama pada tabel di atas.
				</p>
				<p>
					Di samping merupakan data dari hasil kumpulan tangkapan ikan Kelabau
					yang ada di sepanjang sungai Kapuas. Berdasarkan hasil tangkapan
